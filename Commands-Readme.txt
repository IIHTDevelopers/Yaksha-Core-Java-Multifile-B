* Command to run code for use-case 1:
	mvn compile exec:java -Dexec.mainClass="com.iiht.evaluation.yaksha.string.CountStringCharacter"

* Command to run code for use-case 2:
	mvn compile exec:java -Dexec.mainClass="com.iiht.evaluation.yaksha.datevalidation.DateOperation"
